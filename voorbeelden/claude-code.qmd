...
{{< private-video mpALXah_PBg >}}

Deze is wat korter en ook heel leerzaam:

{{< private-video Q0bsphUTLtw >}}
...
Claude Code werkt via de Anthropic API en is op verbruik geprijsd (per token) of via een abonnement. Voor 'gewone' gebruikers is de versie via abonnement aan te raden omdat je dat weliswaar mogelijk tegen gebruiksgrensen aanloopt, maar je in ieder geval zeker weet hoeveel je per maand betaald. 