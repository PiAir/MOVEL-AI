...
Open source modellen zoals [Whisper](/voorbeelden/whisper.qmd) kun je zelf draaien, maar dat vereist krachtige hardware (GPU's). De kosten voor dergelijke hardware lopen stevig in de papieren. Ook hier is kansenongelijkheid een risico tussen studenten die deze hardware thuis hebben en studenten die dat niet hebben.
