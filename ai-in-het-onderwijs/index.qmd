...
listing:
  - id: ai-in-het-onderwijs-voorbeelden
    contents: "tools/ai-in-onderwijs.yml"
    type: grid
  ...
  - id: ai-in-het-onderwijs-organisaties
    contents: "organisaties/ai-in-onderwijs.yml"
    type: grid
    fields: [image, title, description]
    grid-columns: 3
    image-height: 180px
...
Mocht je de inleiding van de module over [AI in het onderwijs](/inleiding/ai-onderwijs.qmd) nog niet bekeken hebben, dan is het goed om dat nu alsnog te doen. De video die daarin centraal staat, geeft een goed beeld van de stand van zaken rondom AI in het onderwijs. De video is van januari 2025, maar geeft nog steeds een goed beeld van de stand van zaken rondom AI in het onderwijs.

## AI in het onderwijs voor de MOVEL-student

Voor jou als student bij de MOVEL zijn [voorbeelden van AI](/voorbeelden/index.qmd) en de specifieke onderwijstoepassingen hieronder op deze pagina interessant. Maar het is niet waar je de MOVEL voor gekozen hebt. Daarom vind je hier ook informatie over de gevolgen van [AI op het curriculum](spinnenweb.qmd), wat [AI betekent voor toetsing](toetsing.qmd) en hoe je het onderwijs binnen jouw organisatie kunt [herontwerpen](herontwerp.qmd).
...
Samen ontwikkelen is heel belangrijk om te voorkomen dat wij in Nederland systemen ontwikkelen zoals het inmiddels [heel bekende voorbeeld uit China](tools/china-voorbeeld.qmd).

## AI in het onderwijs producten

Hieronder vind je een aantal voorbeelden van producten op het gebied van AI in het onderwijs.

::: {#ai-in-het-onderwijs-voorbeelden}
:::

## AI in het onderwijs organisaties
